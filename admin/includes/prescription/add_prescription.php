	...
	$('#prescription_form').validationEngine();
       ...
       <div class="panel-body">
		...
		if($edit){
			...
			<div class="col-sm-1"><input id="days" class="form-control" type="text" value="<?php echo $entry->per_days;?>" name="days[]" placeholder="<?php _e('Total Days','hospital_mgt');?>"></div>
			<div class="col-sm-2">
				<select name="takes_time[]" id="bbb" class="form-control valid">
		...
		<div class="form-group">		
			...
			<div class="col-sm-1"><input id="days" class="form-control" type="text" value="" name="days[]" placeholder="<?php _e('Days','hospital_mgt');//_e('Total Days','hospital_mgt');?>"></div>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<textarea id="note" class="form-control" name="note"><?php if($edit){echo $result->treatment_note; }elseif(isset($_POST['note'])) echo $_POST['note']; ?> </textarea>
			</div>
		</div>
		<?php 
		if($edit){
