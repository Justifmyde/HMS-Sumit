...
if(isset($_POST['save_setting']))
{
	...
	if(isset($_REQUEST['hmgt_enable_outpatientlist_for_outpatient']))
			update_option( 'hmgt_enable_outpatientlist_for_outpatient', 'yes' );
		else 
			update_option( 'hmgt_enable_outpatientlist_for_outpatient', 'no' );
...
<h2>	
		...
		<div class="header">	<hr>
			<h3><?php _e('Outpatient Privacy Setting','hospital_mgt');?></h3>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="hmgt_enable_outpatientlist_for_outpatient"><?php _e("Outpatient can view other outpatient's details","hospital_mgt");?></label>
			<div class="col-sm-8">
				<div class="checkbox">
					<label>
	              		<input type="checkbox" name="hmgt_enable_outpatientlist_for_outpatient"  value="yes" <?php echo checked(get_option('hmgt_enable_outpatientlist_for_outpatient'),'yes');?>/><?php _e('Enable','hospital_mgt');?>
	              </label>
              </div>
			</div>
		</div>
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="hmgt_enable_hospitalname_in_priscription"><?php _e("Hoospital Name print in Prescription","hospital_mgt");?></label>
			<div class="col-sm-8">
				<div class="checkbox">
					<label>
