...
$(document).ready(function() {
	...
	$('#expiry_date').datepicker({
       ...
       <div class="panel-body">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="expiry_date"><?php _e('Expiry Date','hospital_mgt');?></label>
			<div class="col-sm-8">
				<input id="expiry_date" class="form-control" type="text"  name="expiry_date" 
				value="<?php if($edit){ echo $result->medicine_expiry_date;}elseif(isset($_POST['expiry_date'])) echo $_POST['expiry_date'];?>">
			</div>
		</div>		
		<div class="form-group">
