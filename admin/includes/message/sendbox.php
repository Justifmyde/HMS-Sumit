	...
	<div class="mailbox-content">
 	<table class="table">
 		...
 		foreach($message as $msg_post)
 		{
            ...
            <td><a href="?page=hmgt_message&tab=view_message&from=sendbox&id=<?php echo  $msg_post->ID;?>"><?php echo $msg_post->post_title;?><?php if($obj_message->hmgt_count_reply_item($msg_post->ID)>=1){?><span class="badge badge-success pull-right"><?php echo $obj_message->hmgt_count_reply_item($msg_post->ID);?></span><?php } ?></a></td>
             <td>
