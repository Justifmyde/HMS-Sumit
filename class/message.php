...
{	
	...
	public function hmgt_get_inbox_message($user_id,$p=0,$lpm1=10)
	{
		...
		//echo "SELECT DISTINCT b.message_id, a.* FROM $tbl_name_message a LEFT JOIN $tbl_name_message_replies b ON a.post_id = b.message_id WHERE ( a.receiver = $user_id OR b.receiver_id =$user_id) AND msg_status=0 ORDER BY msg_date DESC limit $p , $lpm1";
