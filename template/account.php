...
if(isset($_POST['save_profile_pic']))
	{
		...
		{
			$patient_image=load_documets($_FILES['profile'],'profile','pimg');
			...
			<div class="row">
						...
						<div class="col-md-3 profile-image">
									...
									<?php $umetadata=get_user_meta($user->ID, 'hmgt_user_avatar', true);
													...
													if(empty($umetadata)){
														echo '<img src='.get_default_userprofile($obj_hospital->role).' height="150px" width="150px" class="img-circle" id="profile_pic"/>';
													}
													else
									...
									<div class="col-md-1 update_dp">
										<button class="btn btn-default btn-file" type="file" name="profile_change" id="profile_change"><?php _e('Update Profile','wplms');?></button>
